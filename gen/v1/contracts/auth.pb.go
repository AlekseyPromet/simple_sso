...
func (x *LoginRequest) Reset() {
	*x = LoginRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_contracts_auth_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LoginRequest) Descriptor() ([]byte, []int) {
	return file_contracts_auth_proto_rawDescGZIP(), []int{2}
}
...
type LoginResponse struct {
	...
	Toker string `protobuf:"bytes,1,opt,name=toker,proto3" json:"toker,omitempty"`
}

func (x *LoginResponse) Reset() {
	*x = LoginResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_contracts_auth_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LoginResponse) Descriptor() ([]byte, []int) {
	return file_contracts_auth_proto_rawDescGZIP(), []int{3}
}

func (x *LoginResponse) GetToker() string {
	if x != nil {
		return x.Toker
	}
	return ""
...
var file_contracts_auth_proto_rawDesc = []byte{
	0x0a, 0x14, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x73, 0x2f, 0x61, 0x75, 0x74, 0x68,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x43, 0x0a, 0x0f,
	...
	0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x72, 0x32, 0x76,
	...
	0x65, 0x12, 0x33, 0x0a, 0x08, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x69, 0x6e, 0x67, 0x12, 0x12, 0x2e,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x15, 0x5a, 0x13, 0x70, 0x72, 0x6f, 0x6d, 0x65, 0x74,
...
var (
	...
	file_contracts_auth_proto_rawDescData = file_contracts_auth_proto_rawDesc
)

func file_contracts_auth_proto_rawDescGZIP() []byte {
	file_contracts_auth_proto_rawDescOnce.Do(func() {
		file_contracts_auth_proto_rawDescData = protoimpl.X.CompressGZIP(file_contracts_auth_proto_rawDescData)
	})
	return file_contracts_auth_proto_rawDescData
}

var file_contracts_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_contracts_auth_proto_goTypes = []interface{}{
...
var file_contracts_auth_proto_depIdxs = []int32{
	...
	2, // 1: auth.Auth.Logining:input_type -> auth.LoginRequest
	1, // 2: auth.Auth.Register:output_type -> auth.RegisterResponse
	3, // 3: auth.Auth.Logining:output_type -> auth.LoginResponse
...
func file_contracts_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_contracts_auth_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_contracts_auth_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_contracts_auth_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_contracts_auth_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_contracts_auth_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_contracts_auth_proto_rawDesc = nil
